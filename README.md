...
## Environments
- Preview: https://main--avira--aemysites.aem.page/
- Live: https://main--avira--aemysites.aem.live/
- Block Library: https://main--avira--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `avira` directory in your favorite IDE and start coding :)
